...
//	}
	...
	public void captchaCheck() throws InterruptedException {
	  ...
	  WebElement locator= driver.findElement(By.id("recaptcha-anchor"));

	    base.dynamic_wait_explicitly_visible(2000, locator);
...
//       driver.findElement(By.xpath("//*[@id=\"ctl00_phBody_SignUp_btnContinue\"]")).click();
		WebElement continueBtn = base.dynamic_wait_explicitly_clickable(
            10, By.id("ctl00_phBody_SignUp_btnContinue")
    );
    continueBtn.click();
